...
Route::get('/', function () {
    ...
    // OR: return Redirect::intended('/bands'); 
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/home/regenerate-device-api-key', [HomeController::class, 'regenerateDeviceApiKey'])->name('home.regenerateDeviceApiKey');
